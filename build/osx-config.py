...
CXX            = 'clang++'
CC             = 'clang'
CCFLAGS        = ['-arch', 'x86_64', '-mmacosx-version-min=10.10', '-march=nocona', '-msse2', '-ftree-vectorize', '-funsafe-math-optimizations', '-fno-math-errno', '-isysroot', '/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.10.sdk', '-O3', '-Wall', '-g', '-pipe', '-DMTS_DEBUG', '-DDOUBLE_PRECISION', '-DSPECTRUM_SAMPLES=3', '-fstrict-aliasing', '-fsched-interblock', '-fvisibility=hidden', '-ftemplate-depth=512', '-stdlib=libstdc++']
LINKFLAGS      = ['-framework', 'OpenGL', '-framework', 'Cocoa', '-arch', 'x86_64', '-mmacosx-version-min=10.10', '-Wl,-syslibroot,/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.10.sdk', '-Wl,-headerpad,128', '-stdlib=libstdc++']
